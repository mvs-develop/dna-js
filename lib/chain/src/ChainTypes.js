...
ChainTypes.object_type = {
    ...
    htlc: 16,
    ticket: 18,
    loan_asset_borrow: 20,
    loan_asset_proposal: 21,
};
...
ChainTypes.operations = {
    ...
    witness_reward: 58,
    voter_reward: 59,
    loan_parameters_set_operation: 60,
    loan_asset_create_operation: 61,
    loan_asset_update_operation: 62,
    loan_asset_feed_operation: 63,
    loan_asset_supply_operation: 64,
    loan_asset_withdraw_operation: 65,
    loan_asset_borrow_operation: 66,
    loan_asset_repay_operation: 67,
    loan_asset_liquidate_operation: 68,
    loan_asset_proposal_create_operation: 69,
    loan_asset_proposal_vote_operation: 70,
    loan_asset_claim_mine_operation: 71,
};
