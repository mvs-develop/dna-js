...
export const witness_disable_operation_fee_parameters = new Serializer("witness_disable_operation_fee_parameters", {
    fee: uint64,
});

export const witness_reward_operation_fee_parameters = new Serializer("witness_reward_operation_fee_parameters", {
    fee: uint64,
});

export const voter_reward_operation_fee_parameters = new Serializer("voter_reward_operation_fee_parameters", {
    fee: uint64,
});

export const loan_parameters_set_operation_fee_parameters = new Serializer("loan_parameters_set_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_create_operation_fee_parameters = new Serializer("loan_asset_create_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_update_operation_fee_parameters = new Serializer("loan_asset_update_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_feed_operation_fee_parameters = new Serializer("loan_asset_feed_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_supply_operation_fee_parameters = new Serializer("loan_asset_supply_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_withdraw_operation_fee_parameters = new Serializer("loan_asset_withdraw_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_borrow_operation_fee_parameters = new Serializer("loan_asset_borrow_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_repay_operation_fee_parameters = new Serializer("loan_asset_repay_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_liquidate_operation_fee_parameters = new Serializer("loan_asset_liquidate_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_proposal_create_operation_fee_parameters = new Serializer("loan_asset_proposal_create_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_proposal_vote_operation_fee_parameters = new Serializer("loan_asset_proposal_vote_operation_fee_parameters", {
    fee: uint64,
});

export const loan_asset_claim_mine_operation_fee_parameters = new Serializer("loan_asset_claim_mine_operation_fee_parameters", {
    fee: uint64,
});

export const stablecoin_parameters_set_operation_fee_parameters = new Serializer("stablecoin_parameters_set_operation_fee_parameters", {
    fee: uint64,
});
export const stablecoin_manage_operation_fee_parameters = new Serializer("stablecoin_manage_operation_fee_parameters", {
    fee: uint64,
});
export const stablecoin_proposal_create_operation_fee_parameters = new Serializer("stablecoin_proposal_create_operation_fee_parameters", {
    fee: uint64,
});
export const stablecoin_proposal_vote_operation_fee_parameters = new Serializer("stablecoin_proposal_vote_operation_fee_parameters", {
    fee: uint64,
});
...
var fee_parameters = static_variant([
    ...
    witness_disable_operation_fee_parameters,
    witness_reward_operation_fee_parameters,
    voter_reward_operation_fee_parameters,
    loan_parameters_set_operation_fee_parameters,
    loan_asset_create_operation_fee_parameters,
    loan_asset_update_operation_fee_parameters,
    loan_asset_feed_operation_fee_parameters,
    loan_asset_supply_operation_fee_parameters,
    loan_asset_withdraw_operation_fee_parameters,
    loan_asset_borrow_operation_fee_parameters,
    loan_asset_repay_operation_fee_parameters,
    loan_asset_liquidate_operation_fee_parameters,
    loan_asset_proposal_create_operation_fee_parameters,
    loan_asset_proposal_vote_operation_fee_parameters,
    loan_asset_claim_mine_operation_fee_parameters,
    stablecoin_parameters_set_operation_fee_parameters,
    stablecoin_manage_operation_fee_parameters,
    stablecoin_proposal_create_operation_fee_parameters,
    stablecoin_proposal_vote_operation_fee_parameters
]);
...
export const witness_create = new Serializer("witness_create", {
    ...
    block_producer_reward_pct: uint32
});
...
export const witness_update = new Serializer("witness_update", {
    ...
    block_producer_reward_pct: optional(uint32),
});
...
export const instant_vesting_policy_initializer = new Serializer(
    "instant_vesting_policy_initializer",
    {
    }
);

export const cliff_vesting_policy_initializer = new Serializer(
...
export const witness_disable = new Serializer("witness_disable", {
    fee: asset,
    witness: protocol_id_type("witness"),
    extensions: set(future_extensions)
});

export const witness_reward = new Serializer("witness_reward", {
    fee: asset,
    witness: protocol_id_type("account"),
    total_witness_reward: int64,
    total_voter_reward: int64,
});

export const voter_reward = new Serializer("voter_reward", {
    fee: asset,
    voter: protocol_id_type("account"),
    total_reward: int64,
    witness_rewards: map(protocol_id_type("witness"), int64),
});

export const loan_parameters_set = new Serializer("loan_parameters_set", {
    fee: asset,
    issuer: protocol_id_type("account"),
    options: loan_parameters_option,
    add_mine_assets: set(protocol_id_type("asset")),
    remove_mine_assets: set(protocol_id_type("asset")),
    manager: optional(protocol_id_type("account")),
    refresh_mine_speed: bool,
    extensions: set(future_extensions),
});
export const loan_parameters_option = new Serializer("loan_parameters_option", {
    collateral_factor: optional(uint64),
    lower_liquidate_collateral_ratio: optional(uint64),
    upper_liquidate_collateral_ratio: optional(uint64),
    optional_liquidate_keep_blocks: optional(uint32),
    liquidate_discount_rate: optional(uint64),
    liquidate_close_factor: optional(uint64),
    liquidate_reserve_factor: optional(uint64),
    loan_mine_pay_per_block: optional(int64),
    min_price_feed_count: optional(uint16),
    proposal_create_price: optional(int64),
    proposal_execute_rate: optional(uint64),
});

export const loan_asset_create = new Serializer("loan_asset_create", {
    fee: asset,
    issuer: protocol_id_type("account"),
    asset_type: protocol_id_type("asset"),
    manager: protocol_id_type("account"),
    options: loan_asset_option,
    extensions: set(future_extensions),
});
export const loan_asset_option = new Serializer("loan_asset_option", {
    borrow_interest_rate: uint64,
    multiplier: uint64,
    supply_mine_weight: uint64,
    borrow_mine_weight: uint64,
    can_borrow: bool
});

export const loan_asset_update = new Serializer("loan_asset_update", {
    fee: asset,
    issuer: protocol_id_type("account"),
    asset_type: protocol_id_type("asset"),
    new_manager: optional(protocol_id_type("account")),
    new_options: optional(loan_asset_option),
    extensions: set(future_extensions),
});

export const loan_asset_feed = new Serializer("loan_asset_feed", {
    fee: asset,
    witness: protocol_id_type("account"),
    prices: map(protocol_id_type("asset"), int64),
    extensions: set(future_extensions),
});

export const loan_asset_supply = new Serializer("loan_asset_supply", {
    fee: asset,
    account: protocol_id_type("account"),
    supply_type: protocol_id_type("asset"),
    supply_amount: int64,//share_type
    extensions: set(future_extensions),
});

export const loan_asset_withdraw = new Serializer("loan_asset_withdraw", {
    fee: asset,
    account: protocol_id_type("account"),
    amount: asset,
    extensions: set(future_extensions),
...
export const loan_asset_borrow = new Serializer("loan_asset_borrow", {
    fee: asset,
    account: protocol_id_type("account"),
    asset_type: protocol_id_type("asset"),
    amount: int64,//share_type
    extensions: set(future_extensions),
});

export const loan_asset_repay = new Serializer("loan_asset_repay", {
    fee: asset,
    account: protocol_id_type("account"),
    asset_type: protocol_id_type("asset"),
    amount: optional(int64), //set amount not valid if want to repay all of the borrow
    extensions: set(future_extensions),
});

export const loan_asset_liquidate = new Serializer("loan_asset_liquidate", {
    fee: asset,
    account: protocol_id_type("account"),
    borrow_id: protocol_id_type("loan_asset_borrow"),
    tag_in_advance: bool,
    pay_amount: optional(asset),
    receive_asset: optional(protocol_id_type("asset")), // receive asset
    extensions: set(future_extensions),
});

export const loan_asset_proposal_create = new Serializer("loan_asset_proposal_create", {
    fee: asset,
    proposer: protocol_id_type("account"),
    target_asset: optional(protocol_id_type("asset")),
    new_asset_option: optional(loan_asset_option),
    new_parameters_option: optional(loan_parameters_option),
    start: time_point_sec,
    period_seconds: uint32,
    execute_delay_seconds: uint32,
    extensions: set(future_extensions),
});

export const loan_asset_proposal_vote = new Serializer("loan_asset_proposal_vote", {
    fee: asset,
    voter: protocol_id_type("account"),
    target: protocol_id_type("loan_asset_proposal"),
    amount: int64,//share_type
    extensions: set(future_extensions),
});

export const loan_asset_claim_mine = new Serializer("loan_asset_claim_mine", {
    fee: asset,
    account: protocol_id_type("account"),
    extensions: set(future_extensions),
});

export const stablecoin_parameters_option = new Serializer("stablecoin_parameters_option", {
    proposal_create_price: int64,//share_type
    proposal_execute_rate: uint16,
    proposal_voting_period_min_secs: uint32,
    proposal_voting_period_max_secs: uint32,
    proposal_execute_min_delay_secs: uint32,
    proposal_execute_max_delay_secs: uint32,
});

export const stablecoin_parameters_set = new Serializer("stablecoin_parameters_set", {
    fee: asset,
    issuer: protocol_id_type("account"),
    options: optional(stablecoin_parameters_option),
    system_manager: optional(protocol_id_type("account")),
    stablecoin_managers: map(protocol_id_type("asset"), protocol_id_type("account")),
    extensions: set(future_extensions),
});

export const stablecoin_manage = new Serializer("stablecoin_manage", {
    fee: asset,
    issuer: protocol_id_type("account"),
    asset_type: protocol_id_type("asset"),
    new_manager: optional(protocol_id_type("account")),
    pause_market: optional(bool),
    extensions: set(future_extensions),
});

export const stablecoin_proposal_create = new Serializer("stablecoin_proposal_create", {
    fee: asset,
    proposer: protocol_id_type("account"),
    title: string,
    description: string,
    target_asset: optional(protocol_id_type("asset")),
    new_bitasset_options: optional(bitasset_options),
    new_feed_producers: optional(set(protocol_id_type("account"))),
    new_stablecoin_system_option: optional(stablecoin_parameters_option),
    start: time_point_sec,
    period_seconds: uint32,
    execute_delay_seconds: uint32,
    extensions: set(future_extensions),
...
export const stablecoin_proposal_vote = new Serializer("stablecoin_proposal_vote", {
    fee: asset,
    voter: protocol_id_type("account"),
    target: protocol_id_type("stablecoin_proposal"),
    amount: int64,//share_type
    extensions: set(future_extensions),
});
...
operation.st_operations = [
    ...
    stablecoin_parameters_set,
    stablecoin_manage,
    stablecoin_proposal_create,
    stablecoin_proposal_vote
];
