...
Pure JavaScript DNA library for node.js and browsers. Can be used to construct, sign and broadcast transactions in JavaScript, and to easily obtain data from the blockchain via public apis.
...
```
import {Apis} from "dna-ws-js";
var {ChainStore} = require("dnajs");

Apis.instance("wss://mvsdna.info/ws", true).init_promise.then((res) => {
...
```
var {PrivateKey, key} = require("dnajs");
...
Please have a [look here](https://github.com/mvsdna/dnajs/releases) to find your desired release.
If you want to build the binaries yourself you can clone this repository and run `npm install`. It will
create

-   Browserified version `build/dnajs.js`
-   Browserified and minified (babel) version `build/dnajs.min.js`
-   CommonJS version using wepback `build/dnajs.cjs`
